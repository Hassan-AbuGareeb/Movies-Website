...
const developers = [
  {
    ...
    photo: 'https://drive.google.com/file/d/1zoElnYHwTMOtGojVqVVwSTVFWrdMdt9E/view?usp=sharing',
    linkedin: 'https://www.linkedin.com/in/monabadei/',
    github: 'https://github.com/MonaAlHajEid',
  },
  {
    name: 'Jana Abuhaltam',
    photo: 'https://drive.google.com/file/d/1adexxgVbn79z42KvSVDVKRe1_5jYi64L/view?usp=sharing',
    linkedin: 'https://www.linkedin.com/in/jana-abuhaltam-b00335288/',
    github: 'https://github.com/JanaAbuHaltam',
  },
  {
    name: 'Hassan AbuGareeb',
    photo: 'https://drive.google.com/file/d/1dkUfL5DWT4gSaiohuYN1Sw095XpDFBz0/view?usp=sharing',
  ...
  return (
    <footer className={styles.footer}>
      ...
      <p>
        ...
        latest updates and more movie magic!
      </p>
      <p>© {new Date().getFullYear()} Movie Project Team 7. All rights reserved.</p>
    </footer>
  );
};
